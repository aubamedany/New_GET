...
def fit_models(args):
    ...
    for i in range(args.num_folds):
        ...
        predict_pack = cls_load_data.load_data(root + "/%sfold" % args.num_folds, 'testnew', kfolds = args.num_folds)
        train_pack = cls_load_data.load_data(root + "/%sfold" % args.num_folds, 'trainnew', kfolds = args.num_folds)
        valid_pack = cls_load_data.load_data(root, 'devnew', kfolds = args.num_folds)
